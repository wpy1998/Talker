 ...
 * @author : wpy
 * @description: TODO
 * @date : 4/15/22 6:55 AM
 */
public class NetconfPutInfo {
    private String hostName, userName, password, url;
    private int port;
    @Builder
    public NetconfPutInfo(@NonNull String hostName,
    ...
    public String putInfo() throws IOException, SAXException {
        ...
        String rpcContent = "<get-config message-id=\"" + messageId + "\" " +
                ...
                "<source><running/></source><filter xmlns=\"urn:TBD:params:xml:ns:yang:network-topology\">" +
                "<network-topology/></filter></get-config>";
    ...
    private void writeToXML(String content){
        try {
            BufferedWriter out = new BufferedWriter(new FileWriter("put.xml"));
            out.write(content);
            out.close();
