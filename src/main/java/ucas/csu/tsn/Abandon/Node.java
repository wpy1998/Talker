...
public class Node {
    ...
    public Node(Computer computer){
        ...
        this.node_id = computer.host_name + computer.getCurrentNetworkCard().getMac();
    ...
    public JSONObject getJSONObject(){
        ...
        node.put("id", computer.getCurrentNetworkCard().getMac());
        return node;
    }
    ...
    private class Address{
        ...
        public JSONObject getJSONObject(){
            ...
            object.put("first-seen", Computer.firstSeen);
